      ...
      <>
              ...
              <div className="max-w-3xl py-32 sm:py-40">
                ...
                <div className="">
                  ...
                  <p className="mt-3 text-pretty text-lg font-body text-gray-700 sm:text-xl/8">
                    ...
                    events honoring our shared history, diverse stories, and
                    bold future. Join millions of event in commemorating the
                    spirit of a nation <span className="font-script">250</span>{" "}
                    years in the making.
                  </p>
        ...
        >
          <p className="max-w-4xl text-sm/6 text-gray-700">
            ...
            <a
              href="#"
              className="font-semibold text-saluteRed hover:underline"
            >
              cookie policy
            </a>
            .
